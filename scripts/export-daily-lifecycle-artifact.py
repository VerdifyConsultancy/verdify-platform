    ...
    (out_dir / "README.txt").write_text(
        "\n".join(
            [
                ...
                "",
                "DLI evidence: dli_today_mol_m2 is intentionally blank. Interior crop DLI is unavailable",
                "because the physical sensor is broken. Reason=interior_light_sensor_broken;",
                "provenance=legacy_invalid_exterior_proxy_plus_fixture_estimate;",
                "validity_revision=dli-validity-v1; interval=2024-01-01T00:00:00Z to open.",
                "Outdoor irradiance and fixture runtime are not measured interior crop DLI.",
                "",
