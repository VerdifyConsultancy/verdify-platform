...
| `release-control` | #377 #390 | Waiting | accepted/merged product lanes plus approved merged security checkpoint PR #439 for Phase A; closed credential gate before Phase B | `lane/recovery-release-377-390` / `software-recovery-release-control` | 3492 | PASS | Phase-A tooling may merge with production pending; controller keeps the lane implementing through Phase-B schema/service/state/OTA and settled proof. |
