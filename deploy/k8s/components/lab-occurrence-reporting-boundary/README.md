...
Activation is a separate safety-checked change. That change must create an
...
role; and must replace deny-all with egress limited to the validated reporting
