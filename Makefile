...
climate-intent-shadow-report: ## Replay ClimateIntent shadow actions over the firmware corpus
	$(PYTHON) scripts/climate_intent_shadow_evaluator.py --csv $(REPLAY_CORPUS_GZ)
