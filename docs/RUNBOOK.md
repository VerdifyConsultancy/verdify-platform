...
Consolidated delta from the dual-Iris rollout + overnight incidents. The gateway section is historical; production planning routes through Hermes on OpenAI GPT-5.6 Luna with xhigh reasoning. Read these before debugging any planner/alert-related issue.
