...
- **Route amendment:** 2026-08-25 — route Hermes through Cortex's 98K text alias `llm.primary.longctx`; GitOps activation remains separately gated.
