...
The runtime prompt is split into two layers for the live Hermes/OpenAI GPT-5.6 Sol xhigh-reasoning profile, keeping stable core instructions separate from longer reference material.
