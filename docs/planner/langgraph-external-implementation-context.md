...
- **Planner:** Iris currently uses Hermes + OpenAI GPT-5.5 to choose tactical setpoints and plans through MCP tools.
...
- Some older docs mention OpenClaw/local Gemma. Current production planning uses Hermes `hermes-iris` with OpenAI GPT-5.5 high-reasoning.
