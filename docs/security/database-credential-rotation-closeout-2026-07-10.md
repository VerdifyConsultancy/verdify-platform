...
## Execution request and authority

- Explicit execution request: `rotate-now`, recorded at
  `2026-07-10T12:21:20Z`.
...
- Exact-head security validation: passed after confirming that
